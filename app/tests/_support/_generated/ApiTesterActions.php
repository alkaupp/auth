<?php  //[STAMP] 8d00f3167148c219b15bca4b184821a0
...
trait ApiTesterActions
{
     ...
     *
     *
     * @see \Auth\Tests\_support\Helper\Api::authorizeApp()
     */
    public function authorizeApp($name, $siteUrl, $secretKey) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('authorizeApp', func_get_args()));
    }
     ...
     *
     *
     * @see \Auth\Tests\_support\Helper\Api::registerUser()
     */
    public function registerUser($username, $password, $appId) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('registerUser', func_get_args()));
    }
     ...
     *
     *
     * @see \Auth\Tests\_support\Helper\Api::removeApp()
     */
     ...
     *
     *
     * @see \Auth\Tests\_support\Helper\Api::removeUser()
     */
    public function removeUser($userId) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('removeUser', func_get_args()));
    }
     ...
     *
     *
     * @see \Auth\Tests\_support\Helper\Api::removeUserByUsername()
     */
    public function removeUserByUsername($username) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('removeUserByUsername', func_get_args()));
    }
